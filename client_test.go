...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Contexts.New(context.Background(), browserbaseunofficial.ContextNewParams{
		ProjectID: "projectId",
	})
	if userAgent != fmt.Sprintf("BrowserbaseUnofficial/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Contexts.New(context.Background(), browserbaseunofficial.ContextNewParams{
		ProjectID: "projectId",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Contexts.New(cancelCtx, browserbaseunofficial.ContextNewParams{
		ProjectID: "projectId",
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Contexts.New(deadlineCtx, browserbaseunofficial.ContextNewParams{
			ProjectID: "projectId",
		})
		if err == nil {
