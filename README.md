...
<a href="https://pkg.go.dev/github.com/stainless-sdks/browserbase-unofficial-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/browserbase-unofficial-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Browserbase Unofficial Go library provides convenient access to the Browserbase Unofficial REST API
...
```go
import (
	"github.com/stainless-sdks/browserbase-unofficial-go" // imported as browserbaseunofficial
)
```
...
```sh
go get -u 'github.com/stainless-sdks/browserbase-unofficial-go@v0.0.1'
```
...
The browserbaseunofficial library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/browserbase-unofficial-go/option).
...
`*browserbaseunofficial.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `browserbaseunofficial.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/browserbase-unofficial-go/issues) with questions, bugs, or suggestions.
